...
public class Definition {
	...
	// 当前平台USB路径
	public static final String PATH_USB1 = AppUtil.getUsbPathWithCurrentPlatform(FLAG_USB1);// 当前平台USB1绝对路径
	public static final String PATH_USB2 = AppUtil.getUsbPathWithCurrentPlatform(FLAG_USB2);// 当前平台USB2绝对路径
	// 两个平台USB路径
	...
	public class MediaListConst{
		...
		public static final int FRAGMENT_LIST_MUISC = 0;
		public static final int FRAGMENT_LIST_VIDEO = 1;
		public static final int FRAGMENT_LIST_PHOTO = 2;
		public static final int FRAGMENT_LIST_FAVORITE = 3;
		public static final int FRAGMENT_LIST_FOLDER = 4;
	}
