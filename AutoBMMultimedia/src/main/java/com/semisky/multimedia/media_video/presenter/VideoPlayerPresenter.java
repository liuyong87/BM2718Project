    ...
    private OnPreparedListener mOnPreparedListener = new OnPreparedListener() {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            if (isBindView()) {
                ...
                mViewRef.get().onShowProgramCurrentTime(FormatTimeUtil.makeFormatTime(curProgress));
                PreferencesManager.saveLastVideoUrl(mVideoPlayList.getmCurrentPlayingUrl());
...
//                    }
    ...
    public void onHandlerIntent(Intent intent) {
        ...
        if (null != intent) {
            ...
            if (null != url && !url.equals(PreferencesManager.getLastVideoUrl())) {
                if (canListPlay(url)) {
                    VideoStateManager.getInstance().setVideoIsClickStop(false);
//                    mViewRef.get().setIsNeedPlay(false);
    ...
    public void onRestorePlayVideo() {
        ...
        String lastUrl = PreferencesManager.getLastVideoUrl();
...
//        }
    ...
    // 清除延时全屏线程
    private void removeFullScreenModeTimeoutRunnable() {
