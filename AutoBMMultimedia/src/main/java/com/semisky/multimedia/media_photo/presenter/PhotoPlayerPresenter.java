...
public class PhotoPlayerPresenter<V extends IPhotoPlayerView<PhotoInfo>> extends BasePresenter<V> implements IPhotoPlayerPresenter {
    ...
    public void onHandlerIntent(Intent intent) {
        ...
        if (null != url) {
            PreferencesManager.saveLastPhotoUrl(url);
    ...
    private void onRefreshPhotoPlayPostion() {
        String lastUrl = PreferencesManager.getLastPhotoUrl();
    ...
    public void onLoadData() {
        if (isBindView()) {
            mPhotoDataModel.onLoadPhotoInfoList(new IPhotoDataModel.OnLoadDataListener<PhotoInfo>() {
                @Override
                public void onLoadData(List<PhotoInfo> photoInfoList) {
                    loadData(photoInfoList);
//                    startFullScreenModeTimeoutRunnable();// 延时全屏模式显示
    ...
    private void loadData(final List<PhotoInfo> photoInfoList) {
    ...
    public void onEnterList() {
        if (isBindView()) {
            AppUtil.enterList(MediaListConst.FRAGMENT_LIST_PHOTO);
        }
    }
    ...
    private ViewPager.OnPageChangeListener mOnPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (isBindView()) {
                ...
                if (null != curPhotoUrl) {
                    PreferencesManager.saveLastPhotoUrl(curPhotoUrl);
                }
            }
        }
