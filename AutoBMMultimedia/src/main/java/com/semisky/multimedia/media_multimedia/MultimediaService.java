...
public class MultimediaService extends Service {
    ...
    private void handIntent(Intent intent) {
        ...
        if (action != null && action.equals(Definition.FACTORY_TEST_ACTION_MUSIC)) {
            //音乐
        ...
        } else if (action != null && action.equals(Definition.FACTORY_TEST_ACTION_VIDEO)) {
            //视频
            int value = intent.getIntExtra(Definition.MediaCtrlConst.PARAM_CMD, -1);
            if (value != -1) {
        ...
        } else if (action != null && action.equals(Definition.FACTORY_TEST_ACTION_PICTURE)) {
            //图片
            int value = intent.getIntExtra(Definition.MediaCtrlConst.PARAM_CMD, -1);
            if (value != -1) {
